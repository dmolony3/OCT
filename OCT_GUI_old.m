function OCT_GUI(OCT_cart, OCT_polar, OCT_contour_cart)
...
uicontrol('Parent', GUI.Fig, 'style','pushbutton','units', 'normalized', ...
    ...
    'Callback',@copy_seg, 'fontsize', 10);
uicontrol('Parent', GUI.Fig, 'style','pushbutton','units', 'normalized', ...
    'Position',[0.375 0.275 0.1 0.05], 'String', 'Save', ...
    'Callback',@save_seg, 'fontsize', 10);

% slider for axes
GUI.s1 = uicontrol('Parent', GUI.Fig, 'Style', 'slider', 'units', 'normalized',...
    'Min', 1, 'Max',length(OCT_cart(1,1,:)),'Value',1,'Position', [0.4 0.8 0.275 0.05],...
